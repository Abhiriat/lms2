...
export function AccountPopover({ data = [], sx, ...other }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(IconButton, { onClick: handleOpenPopover, sx: {
                    ...
                    paper: {
                ...
                }, children: [_jsxs(Box, { sx: { p: 2, pb: 1.5 }, children: [_jsx(Typography, { variant: "subtitle2", noWrap: true, children: _myAccount?.displayName }), _jsx(Typography, { variant: "body2", sx: { color: 'text.secondary' }, noWrap: true, children: _myAccount?.email })] }), _jsx(Divider, { sx: { borderStyle: 'dashed' } }), _jsx(MenuList, { disablePadding: true, sx: {
                            p: 1,
                            gap: 0.5,
                            display: 'flex',
                        ...
                        }, children: data.map((option) => (_jsxs(MenuItem, { selected: option.href === pathname, onClick: () => handleClickItem(option.href), children: [option.icon, option.label] }, option.label))) }), _jsx(Divider, { sx: { borderStyle: 'dashed' } }), _jsx(Box, { sx: { p: 1 }, children: _jsx(Button, { fullWidth: true, color: "error", size: "medium", variant: "text", children: "Logout" }) })] })] }));
}
